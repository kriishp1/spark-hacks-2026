      ...
      <nav className="bg-white/40 backdrop-blur-md shadow-sm !py-2 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-8">
          ...
          <div className="flex gap-4">
            <a href="#dashboard" className="px-8 py-2.5 text-lg font-medium text-gray-700 hover:text-[#6F8F72] transition-colors relative group">
              Dashboard
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#6F8F72] group-hover:w-full transition-all duration-300"></span>
            </a>
            <a href="#about" className="px-2 py-2.5 text-lg font-medium text-gray-700 hover:text-[#6F8F72] transition-colors relative group">
              About Us
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#6F8F72] group-hover:w-full transition-all duration-300"></span>
            </a>
            <button className="px-9 py-2.5 text-lg text-[#6F8F72] font-medium hover:bg-gray-100 rounded-full transition-all">
              Login
            </button>
            <button className="px-6 py-2.5 text-lg bg-gradient-to-r from-[#6F8F72] to-[#5c7c60] text-white font-medium rounded-full shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all">
              Sign Up
            </button>
          </div>
        </div>
